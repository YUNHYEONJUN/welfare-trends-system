...
const departments = [
  ...
  // 공공광역센터 (5개)
  { id: '8', name: '경기도노인일자리지원센터' },
  { id: '9', name: '경기도노인종합상담센터' },
  { id: '10', name: '경기도장기요양요원지원센터' },
  { id: '11', name: '경기도노인맞춤돌봄지원센터' },
  { id: '12', name: '경기도지역사회서비스지원단' },
  
  // 노인보호전문기관 (6개)
  { id: '13', name: '경기북서부노인보호전문기관' },
  { id: '14', name: '경기북부노인보호전문기관' },
  { id: '15', name: '경기동부노인보호전문기관' },
  { id: '16', name: '경기서부노인보호전문기관' },
  { id: '17', name: '경기남부노인보호전문기관' },
  { id: '18', name: '경기북동부노인보호전문기관' },
  
  // 학대피해노인전용쉼터 (3개)
  { id: '19', name: '경기북부학대피해노인전용쉼터' },
  { id: '20', name: '경기서부학대피해노인전용쉼터' },
  { id: '21', name: '경기남부학대피해노인전용쉼터' },
];
