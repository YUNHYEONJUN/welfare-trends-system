    ...
    */
    ...
    const mockData = {
      ...
      top_users: [
        ...
        {
          email: 'choi.jiwon@ggpass.or.kr',
          department_name: '경영지원팀',
          activity_count: 134,
          last_activity: new Date(),
        },
        {
          email: 'jung.sooyoung@ggpass.or.kr',
          department_name: '지역협력팀',
          activity_count: 121,
          last_activity: new Date(),
        },
      ...
      recent_admin_actions: [
        {
          id: '1',
          action: 'approve_user',
          admin_email: 'admin@ggpass.or.kr',
          target_email: 'hong.gildong@ggpass.or.kr',
        ...
        },
        {
          ...
          admin_email: 'admin@ggpass.or.kr',
          target_email: 'kim.chulsoo@ggpass.or.kr',
        ...
        },
        {
          ...
          action: 'reject_user',
          admin_email: 'admin@ggpass.or.kr',
          target_email: 'spam@ggpass.or.kr',
